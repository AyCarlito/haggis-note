export default function StorageWarning({ isLow, usage }) {
  ...
  return (
    <div
      role="alert"
      className="flex items-center justify-center gap-2 py-1.5 px-4 text-xs text-warning-fg bg-gradient-to-r from-amber-50 to-yellow-50 border-b border-warning-border"
    >
